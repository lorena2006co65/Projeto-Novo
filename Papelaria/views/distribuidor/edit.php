    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Cadastrar Distribuidor</h2>
                    <form action="update.php" method="post">
                        <p class="form-group">
                            <label for="razao_social">Endereço</label>
                            <input type="text" name="endereco" class="form-control" value="<?= $distribuidor->getEndereco() ?>">
                        </p>
                        <p class="form-group">
                            <label for="cnpj">CNPJ</label>
                            <input type="text" name="cnpj" class="form-control" value="<?= $distribuidor->getCnpj() ?>">
                        </p>
                        <p class="form-group">
                            <label for="telefone">Telefone</label>
                            <input type="text" name="telefone" class="form-control" value="<?= $distribuidor->getTelefone() ?>">
                        </p>
                        <input type="hidden" name="id" value="<?= $distribuidor->getId() ?>">
                        <p class="form-group">
