        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    ...
                    <a href="create.php">Novo Distribuidor</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $distribuidor) : ?>
                            <tr>
                                <td><?= $distribuidor->getId() ?></td>
                                <td><?= $distribuidor->getEndereco() ?></td>
                                <td><?= $distribuidor->getCNPJ() ?></td>
                                <td><?= $distribuidor->getTelefone() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $distribuidor->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $distribuidor->getId() ?>" title="Excluir">
